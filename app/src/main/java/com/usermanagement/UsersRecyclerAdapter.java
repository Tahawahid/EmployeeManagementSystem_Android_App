...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    Context context;
    ArrayList<UsersInfo> usersItemArrayList;
    DatabaseReference databaseReference;

    public UsersRecyclerAdapter(Context context, ArrayList<UsersInfo> usersItemArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        UsersInfo users = usersItemArrayList.get(position);
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || email.isEmpty() || country.isEmpty()) {
                        ...
                        if (newName.equals(name) && newEmail.equals(email) && newCountry.equals(country)) {
                            ...
                            databaseReference.child("USERS").child(id).setValue(new UsersInfo(id, newName, newEmail, newCountry));
